...
export type MutationLoginArgs = {
  options: UsernameOrEmailPasswordInput;
};
...
export type CreatePostMutation = { __typename?: "Mutation" } & {
  createPost: { __typename?: "Post" } & Pick<
    Post,
    "text" | "title" | "updatedAt" | "createdAt" | "points" | "creatorId"
  >;
};
  ...
  posts: { __typename?: "PaginatedPosts" } & Pick<PaginatedPosts, "hasMore"> & {
      posts: Array<
        { __typename?: "Post" } & Pick<
          Post,
          "id" | "title" | "text" | "createdAt" | "updatedAt" | "textSnippet"
        >
      >;
    };
};
...
export const LoginDocument = gql`
  mutation Login($options: UsernameOrEmailPasswordInput!) {
